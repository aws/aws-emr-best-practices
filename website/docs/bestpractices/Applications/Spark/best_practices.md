...
## Tune memory and partitions to fully utilize cluster resources
...
##  BP 5.1.23  - Common health checks recommendations 
...
## Monitor Spark Structured Streaming query progress
